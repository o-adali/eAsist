...
Bilhassa müşterileri adına fatura düzenlemekte olan Muhasebe Ofisleri için idealdir. Her ofis müşterisi için veri tabanında bulunan sütunlara gerekli bilgileri yazmanız yeterlidir.(VKN, eArşiv Portalı kullanıcı adı ve login pass). eAsist FaturaEntegratörleri gibi çalışmaz, düzenlediğiniz faturaya ait verileri CHROME browser aracılığı ile eArşiv Portalına yükler. (Şu anki versiyonumuzda) Portal sayfasından çıkmadan faturanızın onay işlemini yapabilmektesiniz. eAsist Tam Otomatik modda çalışırken fatura onaylama süreci (gelen SMS şifresi girilerek) eAsist üzerinden yapılacaktır. Ardından onaylanan faturanın indirilmesi ve alıcıya email gönderilmesi, faturanın muhasebeye entegre edilmesi gibi rutin süreçler tam otomatik biçimde yapılacaktır.
